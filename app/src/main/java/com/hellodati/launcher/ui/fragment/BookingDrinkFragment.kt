...
import com.hellodati.launcher.databinding.FragmentBookingDrinkBinding
import java.text.SimpleDateFormat
import java.util.Locale

/**
 * A simple [Fragment] subclass.
 * Use the [BookingDrinkFragment.newInstance] factory method to
...
class BookingDrinkFragment : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    private lateinit var binding: FragmentBookingDrinkBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBookingDrinkBinding.inflate(inflater, container, false)
