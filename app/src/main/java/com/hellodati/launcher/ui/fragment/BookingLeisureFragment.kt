...
import com.hellodati.launcher.databinding.FragmentBookingLeisureBinding
...
class BookingLeisureFragment : Fragment() {

    private var itemPosition: Int =0
    private lateinit var binding: FragmentBookingLeisureBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBookingLeisureBinding.inflate(inflater, container, false)
