...
import com.hellodati.launcher.databinding.FragmentBookingMeetingBinding
...
class BookingMeetingFragment : Fragment() {
    // TODO: Rename and change types of parameters
    private var itemPosition: Int = 0
    private var nbr: Int? = 1
    lateinit var myDialog: Dialog
    private lateinit var binding: FragmentBookingMeetingBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBookingMeetingBinding.inflate(inflater, container, false)
        ...
        GlobalScope.launch (Dispatchers.Main) {
            ...
            binding.nbrPerson.addTextChangedListener(object : TextWatcher {
                ...
                override fun afterTextChanged(s: Editable?) {
                    ...
                    if (newNbr != null && newNbr > itemReceived!!.capacity.toInt()) {
                        Toast.makeText(
                            ...
                            resources.getString(R.string.number_of_guests),
                            Toast.LENGTH_LONG
                        ).show()
                        binding.nbrPerson.text = Editable.Factory.getInstance()
            ...
            DatePickerDialog.OnDateSetListener { view, year, monthOfYear, dayOfMonth ->
                ...
                if (isTodayOrFutureDate(selectedDate)) {
                    ...
                    GlobalScope.launch (Dispatchers.Main) {
                        ...
                        Toast.makeText(
                            context,
                            getString(R.string.no_booking_error_date1) + " " + itemReceived!!.title + " " + getString(
