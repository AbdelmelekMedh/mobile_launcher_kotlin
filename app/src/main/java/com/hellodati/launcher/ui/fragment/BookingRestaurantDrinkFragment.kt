...
import com.hellodati.launcher.databinding.FragmentBookingRestaurantDrinkBinding
...
class BookingRestaurantDrinkFragment : Fragment() {
    // TODO: Rename and change types of parameters
    private lateinit var binding: FragmentBookingRestaurantDrinkBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBookingRestaurantDrinkBinding.inflate(inflater, container, false)
                ...
                GlobalScope.launch {
                    withContext(Dispatchers.Main) {
                        ...
                        val createReservationInput = CreateReservationInput(
                            ...
                            reservationType = ReservationTypeEnum.eateries,
    ...
    companion object {
        ...
        fun newInstance(item: SerializableMenuAboutBooking) =
            BookingRestaurantDrinkFragment().apply {
